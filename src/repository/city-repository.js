...
class CityRepository {
  ...
  async getCity(cityId) {
    try {
      ...
      console.log(
        `Error with getting the city details with cityId : ${cityId}`,
      );
      throw { error };
    }
  }
  async updateCity(cityId, cityName) {
    try {
      ...
      console.log(
        `Error with updating the city details with cityId : ${cityId}`,
      );
      throw { error };
    }
  }
  async getAllCities(filter) {
    ...
    try {
      ...
      console.log("Error at the repository layer");
      throw { error };
    }
  }
